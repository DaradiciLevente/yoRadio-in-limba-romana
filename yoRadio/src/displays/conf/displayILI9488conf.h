...
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 58, 3, WA_LEFT }, 140, true, MAX_WIDTH-(TITLE_FIX==0?6*2*7-6:TITLE_FIX), 5000, 2, 40 };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 90, 2, WA_LEFT }, 140, true, MAX_WIDTH, 5000, 2, 40 };
